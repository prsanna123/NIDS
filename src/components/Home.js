...
import koushik from './koush.jpeg';
import arun from './ar.jpeg';
...
export const Home = (props) => {
    ...
    let x2="https://www.linkedin.com/in/tejaswini-mysoola-25bb41251";
    let t2=<a class="link-dark" href={x2}><FaLinkedinIn/></a>
    let x3="https://instagram.com/mysoolatejaswini2404?igshid=ZmRlMzRkMDU=";
    ...
    return (
      ...
      <section className="p-5">
          ...
          <div className="container">
            <div className="row align-items-center justify-content-between">
              <div className="col-md p-5">
                ...
                <p>
                  • Firstly login to the website.(If no log in id, then sign in and move on to the website). <br></br>
                  • Then upload the the inputs of the NSL-KDD dataset parameters as a file. <br></br>
                  • Parameters to enter into the file in single line are : <br></br>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ⁍ count    <br></br>                                
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ⁍ logged_in     <br></br>                     
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ⁍ srv_serror_rate    <br></br>           
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ⁍ serror_rate         <br></br>           
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ⁍ dst_host_serror_rate   <br></br> 
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ⁍ dst_host_same_srv_rate     <br></br>              
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ⁍ dst_host_srv_serror_rate <br></br>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ⁍ dst_host_srv_count <br></br>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ⁍ same_srv_rate <br></br>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ⁍ protocol_type <br></br>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ⁍ service <br></br>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ⁍ flag <br></br>
            ...
            <div className="accordion accordion-flush" id="questions">
              ...
              <div className="accordion-item">
                <h2 className="accordion-header">
                  ...
                  >
                  We know that IPS(Intrusion Prevention System) is dependent on IDS to understand the attack. How does IDS identify malicious traffic?
                  </button>
                </h2>
                <div
                  id="question-three"
        ...
        <section id="instructors" className="p-5 bg-primary">
          <div className="container">
            <h2 className="text-center text-white">DEVELOPERS</h2><br></br>
              ...
              <div className="col-md-3 col-lg-2">
                <div className="card bg-light">
                  <div className="card-body text-center">
                    ...
                    <p className="card-text">
                      <small>I am CSE undergrad from Keshav Memorial Institute of Technology.Interested to work in machine Learning and deep learning projects.</small>
                      
                    </p>
                   <p><small><i className="bi bi-telephone-fill"></i>+91-73966 75154</small></p>
                    {l1}&nbsp;&nbsp;
                    {l2}&nbsp;&nbsp;
                    {l3}&nbsp;&nbsp;
                  </div>
                ...
                <div className="card bg-light">
                  <div className="card-body text-center">
                    <img
                      ...
                      height="130px"
                    />
                    <h6 className="card-title mb-3">MAHESH KUMAR</h6>
                    <p className="card-text">
        ...
        <div className="text-center"><Link className="btn btn-primary  text-center"  to="/model"role="button">Click here to test</Link></div>
