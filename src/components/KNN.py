...
d={}
r=""
f=open(r"D:\NIDS\ML_Projects\Network-Intrusion-Detection-Using-Machine-Learning\inputfile.txt")
...
a=accuracy_score(y_test, y_pred)*100  # calculating accuracy of predicted data
ac=round(a,2)
print("KNN Accuracy with Multi-Class: ", ac)
